...
//        contentView.addConstraint(NSLayoutConstraint(item: retweetedLabel, attribute: NSLayoutAttribute.Width, relatedBy: NSLayoutRelation.Equal, toItem: backButton, attribute: NSLayoutAttribute.Width, multiplier: 1.0, constant: -8))
